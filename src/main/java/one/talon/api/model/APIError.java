...
import one.talon.api.model.ErrorSource;
...
public class APIError   {
   ...
   * @return title
  **/
  @ApiModelProperty(example = "null", required = true, value = "Short description of the problem.")
   ...
   * @return details
  **/
  @ApiModelProperty(example = "null", value = "Longer description of this specific instance of the problem.")
